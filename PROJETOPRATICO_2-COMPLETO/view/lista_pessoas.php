        ...
        <tbody>
            <?php if (count($pessoas) > 0): ?>
                ...
                <tr>
                    ...
                    <td>
                        <a href="editar_pessoa.php?id=<?= $p['id'] ?>" style="text-decoration: none; margin-right: 10px;">Editar</a> | 
                        <a href="lista_pessoas.php?acao=excluir&id=<?= $p['id'] ?>" 
                            onclick="return confirm('Deseja realmente excluir esta pessoa?');" style="color: red; text-decoration: none; margin-left: 10px;">Excluir</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            <?php else: ?>
